...
# for dashboard admin view
    def __init__(self, db_name='foodSystem.db'):
        self.conn = s.connect(db_name, check_same_thread=False)
    ...
    def getTotalOrders(self):
        query = "SELECT COUNT(*) FROM Ordered"
    ...
    def getRecentOrders(self, limit=5):
        query = """
    ...
    def returnAllReviewsRatesAndFoodnos(self):
        query = """
